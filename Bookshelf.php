...
function wpse_load_plugin_css() {
    ...
    wp_enqueue_style( 'book_shelf_style-css', $plugin_url . 'assets/css/book_shelf_style.css' );
    ...
    wp_enqueue_script('book_shelf-script', $plugin_url . 'assets/js/book_shelf.js',  array( 'jquery' ));
}
